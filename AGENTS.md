...
- Keep the existing warm, light, mobile-first editorial UI. See [DESIGN.md](docs/DESIGN.md).
...
- Benchmark contract: [BENCHMARK_METHODOLOGY.md](docs/BENCHMARK_METHODOLOGY.md)
- Model status/capabilities: [MODEL_CATALOG.md](docs/MODEL_CATALOG.md)
- Model provenance/checkpoints: [MODEL_SOURCES.md](docs/MODEL_SOURCES.md)
- Licenses/redistribution: [THIRD_PARTY_LICENSES.md](docs/THIRD_PARTY_LICENSES.md)
...
- Keep model eligibility capability-driven through `src/models/models.js` and `src/core/model-runtime.js`; avoid model-name branching in generic UI/benchmark paths.
