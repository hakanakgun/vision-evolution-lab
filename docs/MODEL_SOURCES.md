...
- Publication policy: the derived browser artifact is published only as the checksum-pinned GitHub Release above. Hugging Face remains the pinned source location for the upstream LibreYOLO checkpoint, not a publication target for this derived asset.
