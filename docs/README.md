...
- [Historical model milestones](MODEL_HISTORY.md) — source-backed timeline context, original task differences, and why history-only references are not runnable or directly comparable.
